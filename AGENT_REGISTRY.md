...
> Master list of all agents in the ChatApp workspace.

| Agent | Folder | Goals | Skills | Heartbeat | Status |
|-------|--------|-------|--------|-----------|--------|
| Product Owner | `agents/product-owner/` | Backlog clarity, sprint predictability, feature delivery, requirement quality | Requirements, Backlog Management, Sprint Planning | Weekly (Monday AM) | Active |
| Backend Developer | `agents/backend-developer/` | Code quality, API reliability, performance, module consistency | API Development, Testing, Code Review, SignalR Development | Weekly (Tuesday) | Active |
